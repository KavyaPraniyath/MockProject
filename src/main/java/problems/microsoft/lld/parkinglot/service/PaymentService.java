...
import problems.microsoft.lld.parkinglot.adapter.PaymentGatewayAdapter;
import problems.microsoft.lld.parkinglot.adapter.RazorpayAdapter;
import problems.microsoft.lld.parkinglot.adapter.StripeAdapter;
import problems.microsoft.lld.parkinglot.domain.Payment;
import problems.microsoft.lld.parkinglot.repository.PaymentRepository;
